...
namespace InventoryManagementSystem {
    ...
    public partial class inventoryDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string ProductName, int BrandId, int ProductQuantity, int ProductUnitPrice, string ProductStatus, double ProductWeight, string ProductDescription) {
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            public double ProductWeight {
                get {
                    try {
                        return ((double)(this[this.tableProducts.ProductWeightColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace InventoryManagementSystem.inventoryDBDataSet1TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([ProductId] = @Original_ProductId) AND ([ProductName] = @Original_ProductName) AND ((@IsNull_BrandId = 1 AND [BrandId] IS NULL) OR ([BrandId] = @Original_BrandId)) AND ([ProductQuantity] = @Original_ProductQuantity) AND ([ProductUnitPrice] = @Original_ProductUnitPrice) AND ([ProductStatus] = @Original_ProductStatus) AND ((@IsNull_ProductWeight = 1 AND [ProductWeight] IS NULL) OR ([ProductWeight] = @Original_ProductWeight)) AND ((@IsNull_ProductDescription = 1 AND [ProductDescription] IS NULL) OR ([ProductDescription] = @Original_ProductDescription)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([ProductName], [BrandId], [ProductQuantity], [ProductUnitPrice], [ProductStatus], [ProductWeight], [ProductDescription]) VALUES (@ProductName, @BrandId, @ProductQuantity, @ProductUnitPrice, @ProductStatus, @ProductWeight, @ProductDescription);
SELECT ProductId, ProductName, BrandId, ProductQuantity, ProductUnitPrice, ProductStatus, ProductWeight, ProductDescription FROM Products WHERE (ProductId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductName] = @ProductName, [BrandId] = @BrandId, [ProductQuantity] = @ProductQuantity, [ProductUnitPrice] = @ProductUnitPrice, [ProductStatus] = @ProductStatus, [ProductWeight] = @ProductWeight, [ProductDescription] = @ProductDescription WHERE (([ProductId] = @Original_ProductId) AND ([ProductName] = @Original_ProductName) AND ((@IsNull_BrandId = 1 AND [BrandId] IS NULL) OR ([BrandId] = @Original_BrandId)) AND ([ProductQuantity] = @Original_ProductQuantity) AND ([ProductUnitPrice] = @Original_ProductUnitPrice) AND ([ProductStatus] = @Original_ProductStatus) AND ((@IsNull_ProductWeight = 1 AND [ProductWeight] IS NULL) OR ([ProductWeight] = @Original_ProductWeight)) AND ((@IsNull_ProductDescription = 1 AND [ProductDescription] IS NULL) OR ([ProductDescription] = @Original_ProductDescription)));
SELECT ProductId, ProductName, BrandId, ProductQuantity, ProductUnitPrice, ProductStatus, ProductWeight, ProductDescription FROM Products WHERE (ProductId = @ProductId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, ProductName, BrandId, ProductQuantity, ProductUnitPrice, Produc" +
                "tStatus, ProductWeight, ProductDescription FROM dbo.Products";
        ...
        public virtual int Delete(int Original_ProductId, string Original_ProductName, global::System.Nullable<int> Original_BrandId, int Original_ProductQuantity, int Original_ProductUnitPrice, string Original_ProductStatus, global::System.Nullable<double> Original_ProductWeight, string Original_ProductDescription) {
            ...
            if ((Original_BrandId.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_BrandId.Value));
            }
            else {
            ...
            if ((Original_ProductWeight.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((double)(Original_ProductWeight.Value));
            }
            else {
        ...
        public virtual int Insert(string ProductName, global::System.Nullable<int> BrandId, int ProductQuantity, int ProductUnitPrice, string ProductStatus, global::System.Nullable<double> ProductWeight, string ProductDescription) {
            if ((ProductName == null)) {
            ...
            if ((ProductWeight.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((double)(ProductWeight.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((ProductWeight.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((double)(ProductWeight.Value));
            }
            else {
            ...
            if ((Original_ProductWeight.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((double)(Original_ProductWeight.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, global::System.Nullable<int> BrandId, int ProductQuantity, int ProductUnitPrice, string ProductStatus, global::System.Nullable<double> ProductWeight, string ProductDescription, int Original_ProductId, string Original_ProductName, global::System.Nullable<int> Original_BrandId, int Original_ProductQuantity, int Original_ProductUnitPrice, string Original_ProductStatus, global::System.Nullable<double> Original_ProductWeight, string Original_ProductDescription) {
            return this.Update(ProductName, BrandId, ProductQuantity, ProductUnitPrice, ProductStatus, ProductWeight, ProductDescription, Original_ProductId, Original_ProductName, Original_BrandId, Original_ProductQuantity, Original_ProductUnitPrice, Original_ProductStatus, Original_ProductWeight, Original_ProductDescription, Original_ProductId);
        }
    }
